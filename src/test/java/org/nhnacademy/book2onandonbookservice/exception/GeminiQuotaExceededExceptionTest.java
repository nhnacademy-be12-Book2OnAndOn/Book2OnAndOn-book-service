...
class GeminiQuotaExceededExceptionTest {
    @Test
    @DisplayName("생성자 테스트: 메시지만 받음")
    void constructor_messageOnly() {
        String message = "에러가 발생했습니다.";

        GeminiQuotaExceededException exception = new GeminiQuotaExceededException(message);
    ...
    void constructor_messageAndCause() {
        ...
        GeminiQuotaExceededException exception = new GeminiQuotaExceededException(message, cause);
