...
class AladinApiExceptionTest {
    ...
    void constructor_messageOnly() {
        ...
        AladinApiException exception = new AladinApiException(message);
    ...
    void constructor_messageAndCause() {
        ...
        AladinApiException exception = new AladinApiException(message, cause);
